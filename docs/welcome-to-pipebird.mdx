...
If you like Pipebird, you can show support by [starring this repo](https://github.com/pipebird/pipebird) 🌟
...
[ ![Customer flow](https://uploads-ssl.webflow.com/6219b67aebd6fd87049d2e0e/630f995f4fcbbc31c0a37f84_CustomerFlow.svg)![Customer flow](https://uploads-ssl.webflow.com/6219b67aebd6fd87049d2e0e/630f995f4fcbbc31c0a37f84_CustomerFlow.svg "Click to close...") ](https://github.com/pipebird/pipebird) 
...
Join the [Pipebird Slack Community](https://join.slack.com/t/pipebirdcommunity/shared%5Finvite/zt-1emvmxdk6-jBc9qXDDgeLhinJ8ktOgHg) or email [\[email protected\]](/cdn-cgi/l/email-protection) if you'd like help with your deployment.
...
Customers can choose to define some set of transformations to be applied on data by uploading Configurations which define mutations on the source data. For example, a consumer may want the Date column updated\_at to be casted into a DateTime object in the destination.
...
We'd love to work with you to grow Pipebird. Feel free to message us in the [Pipebird Slack Community](https://join.slack.com/t/pipebirdcommunity/shared%5Finvite/zt-1emvmxdk6-jBc9qXDDgeLhinJ8ktOgHg).

You can show support by [starring this repo](https://github.com/pipebird/pipebird) 🌟

### Open source vs. paid versions

The Pipebird repo is entirely [MIT licensed](/LICENSE), with the exception of the `ee` directory (if applicable).

Premium features (contained in the `ee` directory) require a Pipebird license. Contact us at [\[email protected\]](/cdn-cgi/l/email-protection) for more information, or see our [pricing page](https://pipebird.com/pricing).
...
Yes! Pipebird is open source so that anyone can benefit from or contribute to our mission. Join us in our [Slack Community](https://join.slack.com/t/pipebirdcommunity/shared%5Finvite/zt-1emvmxdk6-jBc9qXDDgeLhinJ8ktOgHg).